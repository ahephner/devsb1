/*This goes with the calendar program builder funtions*/
...
export default class ProductTableTwo extends LightningElement{
...
//then call get the area info for the product conversions 
        handleMessage(message){
            ...
            this.programId = message.message; 
            this.dateName = true;
...
//close modal
    ...
    setNameDate(mess){
        ...
        this.areaId = mess.detail.areaId;
        this.appType = mess.detail.appType
        this.dateName = false;
        this.productList = true; 
